...
import { CardRecentTransaction } from "./card-recent-transaction.component";

const meta: Meta<typeof CardRecentTransaction> = {
  component: CardRecentTransaction,
  decorators: [
    (Story) => (
      <div
        style={{
...
type Story = StoryObj<typeof CardRecentTransaction>;
